...
export default function CountdownTimer() {
  ...
  // For demo purposes, you can adjust this timestamp
    ...
    <div className="flex flex-col items-center">
      <div className="relative">
        ...
        <div className="relative bg-slate-800/90 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 min-w-[100px] md:min-w-[140px]">
          <div className="text-4xl md:text-6xl font-bold bg-gradient-to-br from-cyan-400 to-blue-500 bg-clip-text text-transparent">
